...
export const ACHIEVEMENTS: AchievementDef[] = [
  // 클릭 3종
  {
    ...
    name: '첫 젓기',
    desc: '솥을 100번 저었다',
    condition: { kind: 'clicks', min: 100 },
  },
  {
    id: 'clicks-1000',
    name: '손에 익은 국자',
    desc: '솥을 1,000번 저었다',
    condition: { kind: 'clicks', min: 1_000 },
  },
  {
    id: 'clicks-10000',
    name: '젓기의 달인',
    desc: '솥을 10,000번 저었다',
    condition: { kind: 'clicks', min: 10_000 },
  },
  ...
  // 견습생 3종
  {
    ...
    name: '첫 제자',
    desc: '견습생 1명을 고용했다',
    condition: { kind: 'generatorCount', generatorId: 'apprentice', min: 1 },
  },
  {
    id: 'apprentice-50',
    name: '작은 학원',
    desc: '견습생 50명을 고용했다',
    condition: { kind: 'generatorCount', generatorId: 'apprentice', min: 50 },
  },
  {
    id: 'apprentice-100',
    name: '마법 학교',
    desc: '견습생 100명을 고용했다',
    condition: { kind: 'generatorCount', generatorId: 'apprentice', min: 100 },
  },
  ...
  // 각 티어 첫 구매 T2~T6 5종
  {
    ...
    name: '끓기 시작',
    desc: '마법 솥을 처음 구매했다',
    condition: { kind: 'generatorCount', generatorId: 'cauldron', min: 1 },
  },
  {
    id: 'herbGarden-1',
    name: '약초 재배',
    desc: '허브 정원을 처음 구매했다',
    condition: { kind: 'generatorCount', generatorId: 'herbGarden', min: 1 },
  },
  {
    id: 'runeCircle-1',
    name: '문양을 새기다',
    desc: '마법진을 처음 구매했다',
    condition: { kind: 'generatorCount', generatorId: 'runeCircle', min: 1 },
  },
  {
    id: 'spiritPact-1',
    name: '정령과의 약속',
    desc: '정령 계약을 처음 맺었다',
    condition: { kind: 'generatorCount', generatorId: 'spiritPact', min: 1 },
  },
  {
    id: 'dragonNest-1',
    name: '용을 깨우다',
    desc: '드래곤 둥지를 처음 구매했다',
    condition: { kind: 'generatorCount', generatorId: 'dragonNest', min: 1 },
  },
  ...
  // 총 누적 마나 4종
  {
    ...
    name: '백만장자',
    desc: '누적 마나 1M 달성',
    condition: { kind: 'lifetimeMana', min: 1e6 },
  },
  {
    id: 'mana-1e9',
    name: '억만금',
    desc: '누적 마나 1B 달성',
    condition: { kind: 'lifetimeMana', min: 1e9 },
  },
  {
    id: 'mana-1e12',
    name: '마나의 바다',
    desc: '누적 마나 1T 달성',
    condition: { kind: 'lifetimeMana', min: 1e12 },
  },
  {
    id: 'mana-1e15',
    name: '무한한 흐름',
    desc: '누적 마나 1000T 달성',
    condition: { kind: 'lifetimeMana', min: 1e15 },
  },
  ...
  // MPS 3종
  {
    ...
    name: '자동화의 시작',
    desc: '초당 마나 100 돌파',
    condition: { kind: 'mps', min: 100 },
  },
  {
    id: 'mps-10000',
    name: '공장 가동',
    desc: '초당 마나 10,000 돌파',
    condition: { kind: 'mps', min: 10_000 },
  },
  {
    id: 'mps-1000000',
    name: '마나 대폭포',
    desc: '초당 마나 1,000,000 돌파',
    condition: { kind: 'mps', min: 1_000_000 },
  },
  ...
  // 각성 2종
  {
    ...
    name: '첫 각성',
    desc: '처음으로 각성했다',
    condition: { kind: 'prestiges', min: 1 },
  },
  {
    id: 'prestige-5',
    name: '윤회의 고리',
    desc: '5번 각성했다',
    condition: { kind: 'prestiges', min: 5 },
  },
  ...
  // 신규 티어 T7~T8 (현자의 탑 1/25, 시공 균열 1/25) 4종
  {
    ...
    name: '지혜의 첨탑',
    desc: '현자의 탑을 처음 세웠다',
    condition: { kind: 'generatorCount', generatorId: 'sageTower', min: 1 },
  },
  {
    id: 'sageTower-25',
    name: '현자들의 회랑',
    desc: '현자의 탑 25개를 세웠다',
    condition: { kind: 'generatorCount', generatorId: 'sageTower', min: 25 },
  },
  {
    id: 'riftGate-1',
    name: '시공을 열다',
    desc: '시공 균열을 처음 열었다',
    condition: { kind: 'generatorCount', generatorId: 'riftGate', min: 1 },
  },
  {
    id: 'riftGate-25',
    name: '차원의 지배자',
    desc: '시공 균열 25개를 열었다',
    condition: { kind: 'generatorCount', generatorId: 'riftGate', min: 25 },
  },
  ...
  // 누적 마나 상위 2종 (1.00aa = 1e18, 1e21)
  {
    id: 'mana-1e18',
    name: '마나의 신화',
    desc: '누적 마나 1.00aa 달성',
    condition: { kind: 'lifetimeMana', min: 1e18 },
  },
  {
    id: 'mana-1e21',
    name: '천문학적 부',
    desc: '누적 마나 1.00ab 달성',
    condition: { kind: 'lifetimeMana', min: 1e21 },
  },
  ...
  // MPS 상위 2종 (1e8, 1e10)
  {
    ...
    name: '마나 범람',
    desc: '초당 마나 100M 돌파',
    condition: { kind: 'mps', min: 1e8 },
  },
  {
    id: 'mps-1e10',
    name: '마나 특이점',
    desc: '초당 마나 10B 돌파',
    condition: { kind: 'mps', min: 1e10 },
  },
  ...
  // 각성 상위 2종 (10회, 25회)
  {
    ...
    name: '거듭된 환생',
    desc: '10번 각성했다',
    condition: { kind: 'prestiges', min: 10 },
  },
  {
    id: 'prestige-25',
    name: '영원의 순례자',
    desc: '25번 각성했다',
    condition: { kind: 'prestiges', min: 25 },
  },
  ...
  // 스타더스트 보유 2종 (25, 100)
  {
    ...
    name: '별먼지 수집가',
    desc: '스타더스트 25개를 모았다',
    condition: { kind: 'stardust', min: 25 },
  },
  {
    id: 'stardust-100',
    name: '별의 주인',
    desc: '스타더스트 100개를 모았다',
    condition: { kind: 'stardust', min: 100 },
  },
  ...
  // 클릭 상위 1종 (50,000)
  {
    ...
    name: '무쇠 손목',
    desc: '솥을 50,000번 저었다',
    condition: { kind: 'clicks', min: 50_000 },
  },
  ...
  // 총 플레이 시간 1종 (10시간)
  {
    ...
    name: '헌신적인 공방장',
    desc: '총 10시간을 플레이했다',
    condition: { kind: 'playtime', min: 10 * 60 * 60 * 1000 },
  },
  ...
  // 골든 이벤트(유성) 클릭 2종 (5회, 25회)
  {
    ...
    name: '유성 사냥꾼',
    desc: '골든 이벤트를 5번 잡았다',
    condition: { kind: 'meteorsClicked', min: 5 },
  },
  {
    id: 'meteors-25',
    name: '하늘의 지배자',
    desc: '골든 이벤트를 25번 잡았다',
    condition: { kind: 'meteorsClicked', min: 25 },
  },
